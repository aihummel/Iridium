...
class IridiumPanel extends JPanel {
    ...
    public IridiumPanel(JFrame frame, int width, int height) {
        ...
        WindowSizePanel wsp = new WindowSizePanel();
    ...
    private class SubPanel extends JPanel {
        ...
        void update() {
            ...
            c.gridx = 0;
            for (FunctionPanel funct : functs) {
                add(funct, c);
        ...
        private class FunctionPanel extends JPanel {
            ...
            Color getColor() {
                if (c.getSelectedIndex() < 7) return colors[c.getSelectedIndex()];
                else if (c.getSelectedIndex() > 7) return colors[c.getSelectedIndex() - 1];
    ...
    private class WindowSizePanel extends JPanel {
        ...
        public WindowSizePanel() {
            ...
            add(ystep);
            presets = new JComboBox<>(sizenames);
